...
Meteor.methods({
  ...
  swimmerInsert: function(swimmerAttributes) {
    //si no tiene foto, agrega una x defecto. NO CARGA LA FOTO ME DICE: FS.File.attachData requires a callback when attaching a URL on the client
    /*
    if (swimmerAttributes.foto == undefined) {
      var fotoHTTP = 'http://chezcoluii.xtrweb.com/img/no_foto.jpg';
